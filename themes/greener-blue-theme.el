;;; greener-blue-theme.el --- Custom theme for faces
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   ;;`(default ((,class (:background "#182623" :foreground "gray80"))))
   ;;`(default ((,class (:background "#182226" :foreground "gray80"))))
   `(default ((,class (:background "#233239" :foreground "gray80")))) ;; lighter version than above
...
(provide-theme 'greener-blue)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; greener-blue-theme.el ends here
