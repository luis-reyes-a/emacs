...
(custom-theme-set-faces
 ...
 '(cursor ((t (:background "AntiqueWhite"))))
 ...
 '(font-lock-function-name-face ((t (:foreground "khaki1"))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "AntiqueWhite"))))
 '(font-lock-warning-face ((t (:bold t :foreground "IndianRed"))))
 '(font-lock-preprocessor-face ((t (:foreground "SkyBlue3" :underline t))))

 ;;extra stuff I added
 '(font-lock-fixme-face ((t (:foreground "Red"        :bold t))))
 '(font-lock-note-face  ((t (:foreground "lime green" :bold t))))
 ...
 '(lazy-highlight ((t (:background "PaleGreen" :foreground "DarkGreen"))))
 ...
 '(isearch-fail ((t (:background "darkslategrey" :foreground "AntiqueWhite" :underline t))))
 
 '(italic ((t (:italic t))))
 '(mode-line ((t (:background "LightSlateGray" :foreground "AntiqueWhite"))))
 '(mode-line-inactive ((t (:background "darkslategrey" :foreground "AntiqueWhite"))))
