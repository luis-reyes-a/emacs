...
(defvar my-keys-minor-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map [C-backspace]   '*backspace-word) ;;sub words
    (define-key map [C-delete]      '*delete-word)
    (define-key map [M-backspace]   '*backspace-identifier) ;;big words
    (define-key map [M-delete]      '*delete-identifier)
...
(custom-set-variables
 ...
 '(package-selected-packages '(doom-themes backward-forward gruvbox-theme))
